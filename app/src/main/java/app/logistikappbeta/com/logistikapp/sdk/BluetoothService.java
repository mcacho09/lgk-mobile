...
package app.logistikappbeta.com.logistikapp.sdk;
...
public class BluetoothService {
  ...
  private synchronized void setState(int state) {
    ...
    mHandler.obtainMessage(PrintTicketActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
  }
  ...
  public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
    ...
    Message msg = mHandler.obtainMessage(PrintTicketActivity.MESSAGE_DEVICE_NAME);
    Bundle bundle = new Bundle();
    bundle.putString(PrintTicketActivity.DEVICE_NAME, device.getName());
    msg.setData(bundle);
  ...
  private void connectionFailed() {
    ...
    Message msg = mHandler.obtainMessage(PrintTicketActivity.MESSAGE_TOAST);
    Bundle bundle = new Bundle();
    bundle.putString(PrintTicketActivity.TOAST, "Unable to connect device");
    msg.setData(bundle);
    mHandler.sendMessage(msg);
  }
  ...
  private void connectionLost() {
    ...
    Message msg = mHandler.obtainMessage(PrintTicketActivity.MESSAGE_TOAST);
    Bundle bundle = new Bundle();
    bundle.putString(PrintTicketActivity.TOAST, "Device connection was lost");
    msg.setData(bundle);
    mHandler.sendMessage(msg);
  }
  ...
  private class ConnectedThread extends Thread {
      ...
      while (true) {
        try {
          ...
          if (bytes > 0) {
            ...
            mHandler.obtainMessage(PrintTicketActivity.MESSAGE_READ, bytes, -1, buffer)
                .sendToTarget();
          } else {
    ...
    public void write(byte[] buffer) {
      try {
        ...
        mHandler.obtainMessage(PrintTicketActivity.MESSAGE_WRITE, -1, -1, buffer)
            .sendToTarget();
      } catch (IOException e) {
